...
const CHANNEL_CONFIG: Record<CampaignChannel, { label: string; icon: typeof MailIcon; variant: "info" | "success" }> = {
  EMAIL: { label: "Email", icon: MailIcon, variant: "info" },
  SMS: { label: "SMS", icon: MessageSquareIcon, variant: "success" },
};
