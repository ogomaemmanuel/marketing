...
public class Segment extends AggregateRoot<SegmentID> {
    ...
    private Segment(String name, RuleSet rules, String createdBy, Instant createdAt) {
    ...
    public static Segment createNew(String name, RuleSet rules, String createdBy, Clock clock) {
        Assert.notNull(clock, "Clock is required");
        return new Segment(name, rules, createdBy, clock.instant());
    }
